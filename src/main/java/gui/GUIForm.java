...
public class GUIForm extends JFrame {
    ...
    private void setLoginPanel() {
        ...
        this.registerButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ServerResponse sr = ClientUtil.register(username, password);
                if (!sr.isGood()) {
                    JOptionPane.showMessageDialog(GUIForm.this,
                            sr.getData(), "Error", JOptionPane.ERROR_MESSAGE);
        ...
        this.loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String username = username_textArea.getText();
                String password = password_textArea.getText();
                ServerResponse sr = ClientUtil.login(username, password);
                if (!sr.isGood()) {
                    JOptionPane.showMessageDialog(GUIForm.this,
                            sr.getData(), "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    ...
                    try {
                        user = new CG_user(RSAEncryptUtil.getPublicKeyFromString(sr.getData()), username, password);
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(GUIForm.this,
    ...
    private void setFilePanel() {
        ...
        encryptButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ServerResponse answer = Main.fileProcess(input_path, output_path, JOptionPane.YES_OPTION, user, usernames);
        ...
        decryptButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ServerResponse answer = Main.fileProcess(input_path, output_path, JOptionPane.NO_OPTION, user, null);
                GUIForm.this.resetFilePanel(answer);
            }
        });
    ...
    private void resetFilePanel(ServerResponse answer) {
        if (answer.isGood()) {
            JOptionPane.showMessageDialog(GUIForm.this, answer.getData(),
